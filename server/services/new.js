...
async function addGame(req, res) {
  try {
    const { user_id, game_name, game_icon, platform } = req.body;
    const data = {
      game_name,
      game_icon,
...
async function addAdUnit(req,res) {
...
async function delete_ad_unit(req,res) {
...
module.exports = {addGame, deleteGame, addAdUnit, delete_ad_unit}
