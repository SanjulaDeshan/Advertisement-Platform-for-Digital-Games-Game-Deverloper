...
import Monitization from './Components/Pages/Monitization/Monitization';
import AdUnit from './Components/Pages/Add unit/AdUnit';
import GameDetails from '../src/Components/Pages/Game details/Gamedetails';
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/Game Deverloper/Monitization" element = {<Monitization />} />
          <Route path="/Game Deverloper/AdUnit" element = {<AdUnit />} /> 
          <Route path="/Game Deverloper/GameDetails" element = {<GameDetails />} />
